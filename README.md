...
<br>
## アピールポイント<br>
力を入れたポイントは、タブレット端末を使ってローカルネットワークではあるもののネットワークマルチプレイを実装しているところです。<br>
サーバー、クライアントの役割に分かれてデータを同期させながら処理を進めていくためにデータの持ち方を考え、処理が重くならないように普段以上に気をつけて処理を組みました。